...
class Hand(object):
    ...
    def update(self, word):
        ...
        # Your code here
	handCopy = {}
	for keys in self.hand.keys():
	    handCopy[keys] = self.hand[keys]
        for letter in word:
...
myHand = Hand(9)
myHand.setDummyHand('lkimejoeo')
myHand.update('milk')#True
print myHand
#eejoo

myHand = Hand(9)
myHand.setDummyHand('aroohwden')
myHand.update('boar')#False
print myHand
#adehnoorw

myHand = Hand(12)
myHand.setDummyHand('tcthccoxvrxz')
myHand.update('chayote')#False
print myHand
#ccchorttvxxz

myHand = Hand(9)
myHand.setDummyHand('uckdbufot')
myHand.update('duck')#True
print myHand
#bfotu
